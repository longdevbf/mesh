...
exports.txBuilder = exports.readValidator = exports.getAddressUTXOAsset = exports.getUtxoForTx = exports.getWalletInfoForTx = exports.getUtxoByTxHash = exports.getTxBuilder = exports.getScript = exports.wallet = exports.blockchainProvider = void 0;
var core_1 = require("@meshsdk/core");
var core_csl_1 = require("@meshsdk/core-csl");
var plutus_json_1 = require("./plutus.json");
var plutus_json_2 = require("./plutus.json");
...
function readValidator(title) {
    var validator = plutus_json_2["default"].validators.find(function (v) { return v.title === title; });
    if (!validator) {
