...
exports.getUtxoForTx = exports.getWalletInfoForTx = exports.getUtxoByTxHash = exports.getTxBuilder = exports.getScript = exports.wallet = exports.blockchainProvider = void 0;
var core_1 = require("@meshsdk/core");
var core_csl_1 = require("@meshsdk/core-csl");
var plutus_json_1 = require("./plutus.json");
exports.blockchainProvider = new core_1.BlockfrostProvider('previewvc1rhxI0zYJBe3C8Atk1W8lm3RVHIUgk');
...
function getUtxoForTx(address, txHash, wallet) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, wallet.fetchAddressUTxOs(address)];
                case 1:
                    utxos = _a.sent();
