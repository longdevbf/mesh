...
const txHash = await wallet.submitTx(signedTx);
    ...
    async function main(){
      ...
      const metadata = {
          name: tokenName ,
          image: "bafybeifq4vh5ebzq3h73pnksrdrxovt66g5ku3jjcggjjwxra3mcqxhe5m",
          mediaType: "image/jpg", 
          description: "My second  CIP68 token DID",
          _pk: userPubkeyHash, // Required by validator
          data: "https://emerald-managing-koala-687.mypinata.cloud/ipfs/QmaVSL5to1QxqknYp27X1o74Zvaa6eeSpyJbgs9WUQomnz",
        };
